...
# "коллекция" сюда не входит — у неё своя заглушка, "Без коллекции"
# (см. transform_increment), как в update_sales_sku.py
FILL_NO_DATA_COLUMNS = ["артикул", "категория", "бит_литера"]
